...
![pic](<img/Screenshot (893).png>)

![pic](<img/Screenshot (867).png>)

![pic](<img/Screenshot (868).png>)

![pic](<img/Screenshot (870).png>)

![pic](<img/Screenshot (871).png>)
...
![pic](<img/Screenshot (902).png>)

![pic](<img/Screenshot (903).png>)

![pic](<img/Screenshot (916).png>)

## Elite corporation AWS EC2 instance created, with t2.micro as the type of instance.

![pic](<img/Screenshot (919).png>)
...
Conclusion
Automating EC2 instance deployment with Terraform in VS Code enables fast, reliable, and repeatable infrastructure setup. It enhances cloud resource management, reduces errors, and minimizes manual effort, ensuring scalability and efficiency